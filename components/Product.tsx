...
const Product = ({
  ...
  return (
    <div className="wrapper rounded-md shadow-md min-h-110 sm:h-110 md:h-88 lg:h-100 ease-in-out duration-200 ">
          ...
          <div className="price flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="priceNumber flex items-end justify-end gap-1">
              <p
                className={` ${
                  promotion &&
                  " text-base text-neutral-500 line-through font-normal"
                } font-bold text-xl text-yellow-500`}
              >
                ${price}
              </p>
              {promotion && (
                <p className="text-2xl text-red-500 font-bold">${promotion}</p>
              )}
            </div>
          </div>
        </div>
